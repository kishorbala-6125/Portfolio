...
<body>
    <header>
        <div class="header-content">
            ...
            <img src="/storage/emulated/0/Pictures/Screenshots/IMG_20250402_191901.jpg" alt="Your Profile Picture" class="profile-picture">
            <h1>Kishor bala k</h1>
    ...
    <section id="resume">
        ...
        <div class="section-content">
            <center>
            <h2>Resume</h2>
            <a href="/storage/emulated/0/Download/kishor bala k resume.pdf" target="_blank" class="download-button">Download CV</a>
        </center>
        </div>
